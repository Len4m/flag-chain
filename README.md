...
> ⚠️ **Este proyecto está en una etapa muy temprana.**  
> Las ideas, estructuras y componentes están sujetos a cambios frecuentes.

- 🔬 Actualmente trabajando en:
  - Contratos inteligentes (`FlagChain.sol`)
  - SDK inicial en TypeScript
  - Prototipo de frontend (Angular + Ethers.js)
...
¡Gracias por tu interés en FlagChain!
